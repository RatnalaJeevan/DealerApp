...
public class RecordVideoPostsActivity/* extends Activity implements
   ...
   /* protected static final int RESULT_ERROR = 0x00000001;
    ...
    private void initView() {
        ...
        iv_record.setImageResource(R.drawable.ic_play_button);

        tv_counter =  findViewById(R.id.timer);
    ...
    private void startRecord() {
        try {
            if (initVideoRecorder()) {
                ...
                iv_record.setImageResource(R.drawable.ic_stop_24dp);
            } else {
                releaseMediaRecorder();
                iv_record.setImageResource(R.drawable.ic_play_arrow_black_24dp);
            }
    ...
    private File setUpVideoFile() throws IOException {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment
            ...
            videoFile = File.createTempFile("MP4File"
